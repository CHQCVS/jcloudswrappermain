...
public interface JCloudsWrapperService {
     ...
     * <br>Note: This assumes that a Keypair name called "cloudkey" exists in the cloud provider</br>
     * <br>Note: This assumes that a security group name called "default" exists in the cloud provider</br>
    ...
    Set<VMMetadata> provisionVM(OperatingSystemImage operatingSystemImage,
        ...
        List<String> floatingIPAddresses, String script);
     ...
     * @return - {@link Set} of {@link VMMetadata} of newly provisioned VMs
     */
    Set<VMMetadata> provisionVM(Integer count, String groupName, List<String> floatingIPAddresses, String script);    
